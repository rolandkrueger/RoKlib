/*
 * $Id: SingleLongURLParameterTest.java 186 2010-11-01 10:12:14Z roland $
...
import info.rolandkrueger.roklib.webapps.urldispatching.urlparameters.SingleLongURLParameter;

public class SingleLongURLParameterTest extends AbstractSingleURLParameterTest<Long>
{
  @Override
  public AbstractSingleURLParameter<Long> getTestSingleURLParameter (String parameterName)
  {
    return new SingleLongURLParameter ("test");
  }
