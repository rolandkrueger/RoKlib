/*
 * $Id: URLParametersTests.java 186 2010-11-01 10:12:14Z roland $
...
@RunWith(Suite.class)
@SuiteClasses ({
  SingleBooleanURLParameterTest.class,
  SingleDoubleURLParameterTest.class,
  SingleFloatURLParameterTest.class,
  SingleIntegerURLParameterTest.class,
  SingleLongURLParameterTest.class,
  SingleStringURLParameterTest.class,
  Point2DURLParameterTest.class
}) 
