/*
 * $Id: SingleFloatURLParameterTest.java 186 2010-11-01 10:12:14Z roland $
...
{
  @Override
  public AbstractSingleURLParameter<Float> getTestSingleURLParameter (String parameterName)
  {
    return new SingleFloatURLParameter ("test");
  }
