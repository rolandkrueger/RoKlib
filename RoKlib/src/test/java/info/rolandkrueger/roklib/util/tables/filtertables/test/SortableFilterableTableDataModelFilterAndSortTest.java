...
public class SortableFilterableTableDataModelFilterAndSortTest
{
  ...
  public void setUp ()
  {
    mTestObj = new SortableFilterableTableDataModel<String, DefaultTableDataColumnHeader> (4, SearchMode.BOTH);
    ...
    mTestObj.addStringData ("Australia").addStringData ("23").addData (23).addData (5.17, "Canberra");
