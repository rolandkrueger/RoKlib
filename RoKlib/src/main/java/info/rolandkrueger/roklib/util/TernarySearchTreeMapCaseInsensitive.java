/*
 * $Id: TernarySearchTreeMapCaseInsensitive.java 254 2011-01-25 18:48:50Z roland $
...
public class TernarySearchTreeMapCaseInsensitive<V> implements ITernarySearchTreeMap<V>
{
  ...
  public Entry<CharSequence, V> getEntry (Object key)
  {
    ...
    return entry == null ? null : 
      new AbstractMap.SimpleEntry<CharSequence, V> (entry.getValue ().getKey (), entry.getValue ().getValue ());
  }
  ...
  {
    Map.Entry<CharSequence, Map.Entry<CharSequence, V>> entry = mData.predecessorEntry (forElement.toString ().toLowerCase (mLocale));
    return entry == null ? null : entry.getValue ().getKey ();
  }
  
  public CharSequence successor (CharSequence forElement)
  {
    Map.Entry<CharSequence, Map.Entry<CharSequence, V>> entry = mData.successorEntry (forElement.toString ().toLowerCase (mLocale));
    return entry == null ? null : entry.getValue ().getKey ();
  }
  ...
  public Iterable<CharSequence> getPrefixMatch (CharSequence prefix)
  {
    ...
    final Iterator<Entry<CharSequence, Map.Entry<CharSequence, V>>> iterator =
      mData.getPrefixSubtreeIterator (prefix.toString ().toLowerCase (mLocale), false).iterator ();
      ...
      boolean inverseSearch)
  {
    ...
    final Iterator<Entry<CharSequence, Map.Entry<CharSequence, V>>> iterator =
      mData.getPrefixSubtreeIterator (pPrefix.toString ().toLowerCase (mLocale), inverseSearch).iterator ();
  ...
  {
    Map.Entry<CharSequence, Map.Entry<CharSequence, V>> entry = mData.predecessorEntry (((CharSequence) keyObject).toString ().toLowerCase (mLocale));
    return entry == null ? null : entry.getValue ();
  }

  public Entry<CharSequence, V> successorEntry (Object keyObject)
  {
    Map.Entry<CharSequence, Map.Entry<CharSequence, V>> entry = mData.successorEntry (((CharSequence) keyObject).toString ().toLowerCase (mLocale));
    return entry == null ? null : entry.getValue ();
  }
  ...
  public boolean containsValue (Object pValue)
  {
    ...
    {
      if (entry.getValue ().equals (pValue)) return true;
    }
    return false;
  }
  ...
  private class TSTEntrySetCaseInsensitive extends AbstractSet<Entry<CharSequence, V>> implements Serializable
  {
    ...
    public TSTEntrySetCaseInsensitive (CharSequence fromKey, CharSequence toKey)
    {
      ...
      {
        mEntrySet = mData.subMap (fromKey.toString ().toLowerCase (mLocale), toKey.toString ().toLowerCase (mLocale)).entrySet (); 
    ...
    private Collection<?> getEntriesFromMap (Collection<?> collection)
    {
      ...
      for (Object obj : collection)
      {
        ...
        if (mapEntry != null) list.add (mapEntry);
      }
      return list;
    }
  ...
  private class TSTSubMapCaseInsensitive extends AbstractMap<CharSequence, V> implements SortedMap<CharSequence, V>, Serializable
  {
    ...
    public SortedMap<CharSequence, V> subMap (CharSequence fromKey, CharSequence toKey)
    {
      ...
      result.mSubMap = mSubMap.subMap (fromKey.toString ().toLowerCase (mLocale), toKey.toString ().toLowerCase (mLocale));
      return result;
    }
