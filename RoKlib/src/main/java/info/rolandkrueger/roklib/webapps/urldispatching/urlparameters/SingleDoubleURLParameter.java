...
public class SingleDoubleURLParameter extends AbstractSingleURLParameter<Double>
{
  ...
  public SingleDoubleURLParameter (String parameterName, Double defaultValue)
  {
    super (parameterName);
