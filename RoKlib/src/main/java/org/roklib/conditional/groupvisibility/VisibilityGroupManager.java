...
public class VisibilityGroupManager implements Serializable {
     ...
     *
     * @param groupName identifier name for a {@link VisibilityGroup} object managed by this {@link VisibilityGroupManager}
     ...
     *
     * @param groupName  name of the {@link VisibilityGroup} for which the given {@link BooleanExpression} is set
     * @param expression {@link BooleanExpression} which is responsible for making the components of the specified
     ...
     *
     * @param groupName  name of the {@link VisibilityGroup} for which the given {@link BooleanExpression} is set
     * @param expression {@link BooleanExpression} which is responsible for enabling or disabling the components of the specified
