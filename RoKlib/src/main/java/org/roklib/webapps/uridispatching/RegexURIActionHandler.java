 ...
 * </p>
 * <p>
 * A {@link RegexURIActionHandler} is itself a {@link DispatchingURIActionHandler}, that is, it can have its own
 * sub-handlers to which the responsibility to interpret part of a URI can be passed. To set the action command for this
 * {@link RegexURIActionHandler} in case there are no more URI tokens to be passed to sub-handlers (i. e. the currently
 ...
 * have to provide a value for the URI token used to represent this {@link RegexURIActionHandler}. This is done with
