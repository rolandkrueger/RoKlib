...
public abstract class AbstractHoverableAction extends AbstractAction implements Hoverable {
     ...
     *
     * @param toolbar target toolbar that this action will be added to
     */
     ...
     * {@link java.awt.event.MouseListener}s will be registered so that hover events will correctly by disseminated.
     *
     * @param menu target menu that this action will be added to
     */
     ...
     *
     * @param listener a {@link HoverListener} registering for hover events
     ...
     *
     * @param hoverMessage a help message for this action
     */
     ...
     *
     * @param mnemonicKey one of the key constants as defined in {@link Action}.
     */
